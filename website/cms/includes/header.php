    ...
    <div class="row g-0">
        <nav class="col-md-3 col-lg-2 cms-sidebar p-3">
            ...
            <?php if (auth_can('news', false)): ?>
                ...
                <a href="<?= htmlspecialchars(app_url('website/cms/fenomenos.php')) ?>" class="<?= ($cmsNav ?? '') === 'fenomenos' ? 'active' : '' ?>"><i class="fa-solid fa-cloud-sun-rain me-2"></i>Fenómenos · reportes y bomberos</a>
            <?php endif; ?>
